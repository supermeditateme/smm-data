...
var SelectedAnnotation = function (_PureComponent) {
  ...
  function SelectedAnnotation(props) {
    ...
    _this.selectedRef = React__default.createRef();
  ...
  _createClass(SelectedAnnotation, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(
        ...
        React__default.createElement('div', { className: 'leftBorder', onMouseDown: this.startDraggingWest }),
        React__default.createElement('div', { className: 'rightBorder', onMouseDown: this.startDraggingEast }),
        React__default.createElement(
          'div',
          { className: 'annotationDuration' },
          React__default.createElement('div', { className: 'measureLine' }),
          React__default.createElement('div', { className: 'leftGapper' }),
          React__default.createElement(
            'div',
...
var SelectedAnnotationWrapper = function (_Component) {
  ...
  function SelectedAnnotationWrapper() {
    ...
    return _ret = (_temp = (_this3 = _possibleConstructorReturn(this, (_ref = SelectedAnnotationWrapper.__proto__ || Object.getPrototypeOf(SelectedAnnotationWrapper)).call.apply(_ref, [this].concat(args))), _this3), _this3.handleKeyDown = function (e) {
      ...
      switch (key) {
        case 'Backspace':
        case 'Delete':
          dispatch(__chunk_7.deleteAnnotation(selected.id));
        ...
        case 'ArrowDown':
          ...
          dispatch(__chunk_7.selectAnnotation(sortedAnnotations[idx].id));
          dispatch(__chunk_2.softSetCurrentTime(sortedAnnotations[idx].time - 0.2));
          break;
      ...
      _this3.props.dispatch(__chunk_7.modifyAnnotation(_extends({}, _this3.props.selected, annotationData)));
  ...
  _createClass(SelectedAnnotationWrapper, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(SelectedAnnotation, {
        key: selected.id,
        time: selected.time,
...
var mapStateToProps = function mapStateToProps(state) {
  return {
    sortedAnnotations: __chunk_19.getSortedAnnotations(state),
    selected: __chunk_19.getSelectedAnnotation(state),
    secondWidth: __chunk_17.getSecondWidth(state)
  };
};

var SelectedAnnotation$1 = reactRedux.connect(mapStateToProps, undefined, undefined, {
  storeKey: __chunk_1.STORE_KEY
})(SelectedAnnotationWrapper);

exports.default = SelectedAnnotation$1;
