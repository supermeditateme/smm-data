  ...
  _createClass(ExampleCache, [{
    ...
    value: function getChunksAsync(start, _size) {
      ...
      if (canGetFromCache) {
        ...
        return __chunk_29.default().resolve(this._data.slice(start, start + size));
      }

      // ...complex case - we don't have everything.
      var deferredPromise = __chunk_29.default(function (res, rej) {
