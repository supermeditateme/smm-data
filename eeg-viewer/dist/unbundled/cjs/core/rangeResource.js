...
var __chunk_24 = require('./edf/funnelBuffer.js');
var __chunk_25 = require('./edf/arrBuffer.js');
var __chunk_26 = require('./edf/edfHeader.js');
var __chunk_28 = require('./edf/edfStreamReader.js');
var __chunk_29 = require('./deferred.js');
  ...
  _createClass(ExampleRangeResource, [{
    ...
    value: function _fetchHeader() {
      ...
      var headerPromise = this._fetch(this.url, {
        ...
        return new __chunk_26.default(stream).then(function (header) {
          _this3._emit('finish');
    ...
    value: function _fetchChunks(requestId, start, size) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _this4._fetch(_this4.url, {
          ...
          return __chunk_28.default(source, function (dataRecord, index, total, edfHeader) {
...
exports.default = ExampleRangeResource;
