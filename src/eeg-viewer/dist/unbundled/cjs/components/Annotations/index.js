...
require('../../selectors/navigation.js');
        ...
        visibleAnnotationsWithCoordinates.map(function (annotationWithCoordinates) {
          ...
          return React__default.createElement(Annotation, {
            ...
            onClick: function onClick() {
              return _this3.props.dispatch(__chunk_7.selectAnnotation(annotation.id));
            }
          });
        })
      );
...
var mapStateToProps = function mapStateToProps(state) {
  return {
    visibleAnnotationsWithCoordinates: __chunk_19.getVisibleAnnotationsWithCoordinates(state)
  };
};

var Annotations$1 = reactRedux.connect(mapStateToProps, undefined, undefined, {
  storeKey: __chunk_1.STORE_KEY
})(Annotations);

exports.default = Annotations$1;
