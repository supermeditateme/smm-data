      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          seconds.map(function (item, idx) {
            return React.createElement('i', { key: idx, className: 'second_line' });
          })
        )
      );
    }
...
var Segment = function (_PureComponent2) {
  ...
  _createClass(Segment, [{
    ...
    value: function render() {
      ...
      var seconds = new Array(SEGMENT_DURATION / secConfiguration[epochSize].value).fill(null);
      ...
      return React.createElement(
        ...
        seconds.map(function (second, idx) {
          var value = _this3.parseTime(segmentIndex * SEGMENT_DURATION + idx * secConfiguration[epochSize].value);

          return React.createElement(Second, {
...
var Ruler$1 = connect(mapStateToProps, undefined, undefined, {
  storeKey: STORE_KEY
})(Ruler);
