...
import { getSecondWidth } from './navigation.js';
...
var getDerivedChannels = createSelector(function (state) {
...
var getChannelSettings = createSelector(function (state) {
...
var getVisibleChannels = createSelector(function (state) {
...
var getPossibleChannels = createSelector(getChannelSettings, function (channelSettings) {
  return Object.keys(channelSettings).filter(function (label) {
    return !channelSettings[label].invalid;
  });
});

var getStepWidth = createSelector(getVisibleChannels, function (state) {
  return state.header.dataRecordDuration;
}, getSecondWidth, function (visibleChannel, dataRecordDuration, secondWidth) {
  var stepWidth = {};
  ...
  var _loop2 = function _loop2(channel) {
    ...
    if (!stepWidth[currentSampleRate]) {
      var length = SEGMENT_DURATION / dataRecordDuration * currentSampleRate;
...
export { getDerivedChannels, getChannelSettings, getVisibleChannels, getPossibleChannels, getStepWidth };
